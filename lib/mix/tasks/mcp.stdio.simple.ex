  ...
  defp process_request(%{"method" => "tools/list", "id" => id}) do
    ...
    tools = [
      %{
        ...
        description: "Schedule activities using AriaEngine's temporal planner with entity and resource management",
        inputSchema: %{
          type: "object",
          properties: %{
            activities: %{
              ...
              items: %{
                ...
                properties: %{
                  ...
                  entities: %{type: "array", items: %{type: "string"}, description: "Required entities"},
            ...
            constraints: %{
              ...
              properties: %{
                start_time: %{type: "string", description: "Earliest start time (ISO 8601)"},
                end_time: %{type: "string", description: "Latest end time (ISO 8601)"}
              }
            }
          },
          required: ["activities"]
