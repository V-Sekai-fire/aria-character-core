...
defmodule AriaStorage.Chunks.Assembly do
  ...
  @doc """
  Validate that chunks match the index.
  """
  ...
  @doc """
  Verify chunk integrity during assembly.
  """
  ...
  def verify_chunk(chunk) do
    ...
    cond do
      ...
      chunk.checksum != expected_checksum ->
        {:error, :chunk_checksum_mismatch}

      chunk.size != byte_size(chunk.data) ->
  ...
  @doc """
  Check if all chunks are present and in order.
  """
