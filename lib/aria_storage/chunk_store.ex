...
defmodule AriaStorage.ChunkStore do
  @moduledoc """
  Generic chunk store interface for different storage backends.
  ...
  """
  @callback delete_chunk(store :: t(), chunk_id :: chunk_id()) ::
              :ok | {:error, term()}

  @doc """
  List chunks in the storage backend.
  """
  @callback list_chunks(store :: t(), opts :: keyword()) ::
              {:ok, [chunk_id()]} | {:error, term()}
  ...
  @doc """
  Store a chunk using the appropriate backend.
  """
  ...
  @doc """
  Retrieve a chunk using the appropriate backend.
  """
  ...
  @doc """
  Check if a chunk exists using the appropriate backend.
  """
  ...
  @doc """
  Delete a chunk using the appropriate backend.
  """
  ...
  @doc """
  List chunks using the appropriate backend.
  """
  ...
  @doc """
  Get storage statistics using the appropriate backend.
  """
