defmodule DomainAPI do
  @moduledoc "Provides functions for building and managing the domain capabilities of the Aria Engine.\n"
  alias Core
  alias Domain
  @type t :: Core.t()
  ...
  @doc "Creates an AriaEngine definition from an existing Domain.\n"
  @spec from_domain(Domain.Core.t(), [todo_item()], AriaEngine.State.t() | nil) :: t()
  def from_domain(%Domain.Core{} = domain, goals, initial_state \\ nil) do
    initial_state = initial_state || AriaEngine.State.new()
  ...
  @doc "Converts an AriaEngine definition to a Domain (capabilities only).\n"
  ...
  @doc "Adds an action to the AriaEngine definition.\n"
  ...
  @doc "Adds multiple actions to the definition.\n"
  ...
  @doc "Adds a task method to the definition.\n"
  ...
  @doc "Adds multiple task methods for a task.\n"
  ...
  @doc "Adds a unigoal method to the definition.\n"
  ...
  @doc "Adds multiple unigoal methods for a goal type.\n"
  ...
  @doc "Adds a multigoal method to the definition.\n"
  ...
  @doc "Adds multiple multigoal methods.\n"
  ...
  @doc "Merges two method maps, combining method lists for the same keys.\n\nWhen both maps have the same key, the method lists are concatenated.\n"
