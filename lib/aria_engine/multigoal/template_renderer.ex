...
defmodule AriaEngine.Multigoal.TemplateRenderer do
  ...
  EEx.function_from_string(:defp, :general_template, """
  ...
  EEx.function_from_string(:defp, :spatial_template, """
  ...
  EEx.function_from_string(:defp, :dependency_template, """
  ...
  EEx.function_from_string(:defp, :parallel_template, """
  ...
  EEx.function_from_string(:defp, :resource_template, """
