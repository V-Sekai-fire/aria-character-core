...
defmodule AriaEngine.Timeline.IntervalRelations do
  ...
  def after?(interval1, interval2), do: before?(interval2, interval1)
  ...
  def met_by?(interval1, interval2), do: meets?(interval2, interval1)
  ...
  def overlapped_by?(interval1, interval2), do: overlaps?(interval2, interval1)
  ...
  def started_by?(interval1, interval2), do: starts?(interval2, interval1)
  ...
  def contains?(interval1, interval2), do: during?(interval2, interval1)
  ...
  def finished_by?(interval1, interval2), do: finishes?(interval2, interval1)
