...
defmodule AriaEngine.Timeline.IntervalRelations do
  ...
  @doc "Checks if interval1 overlaps interval2.\n\nAllen's 'overlaps' relation: X o Y\nX starts before Y, ends during Y.\n\n## Examples\n\n    iex> alias Timeline.{Interval, IntervalRelations}\n    iex> i1 = Interval.new_fixed_schedule(~N[2025-01-01 10:00:00], ~N[2025-01-01 13:00:00])\n    iex> i2 = Interval.new_fixed_schedule(~N[2025-01-01 12:00:00], ~N[2025-01-01 15:00:00])\n    iex> IntervalRelations.overlaps?(i1, i2)\n    true\n\n"
