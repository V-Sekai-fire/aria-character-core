...
defmodule Timeline.Internal.STN.Units do
  ...
  @spec convert_datetime_duration_to_stn_units(DateTime.t(), DateTime.t(), time_unit(), lod_level(), lod_resolution()) :: number()
  def convert_datetime_duration_to_stn_units(start_dt, end_dt, target_unit, _lod_level, lod_resolution) do
