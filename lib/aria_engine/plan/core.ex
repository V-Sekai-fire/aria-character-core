...
defmodule AriaEngine.Plan.Core do
  ...
  def plan(domain, %AriaEngine.StateV2{} = state, todos, opts \\ []) do
    ...
    # Add blacklisted commands from opts if provided
    blacklisted_commands = Keyword.get(opts, :blacklisted_commands, MapSet.new())
    solution_tree = %{solution_tree | blacklisted_commands: blacklisted_commands}
