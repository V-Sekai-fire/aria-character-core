defmodule Domain.Methods do
  ...
  @doc "Adds a task method to the domain with automatic method name inference.\n"
  ...
  @doc "Gets unigoal methods for a goal type.\n\nReturns a list of {method_name, method_function} tuples.\n"
  ...
  @doc "Checks if task methods exist for a task.\n"
  ...
  @doc "Checks if unigoal methods exist for a goal type.\n"
