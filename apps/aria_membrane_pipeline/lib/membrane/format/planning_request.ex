...
defmodule Membrane.Format.PlanningRequest do
  ...
  @doc "Validates a planning request format structure.\n\n## Examples\n\n    iex> request = %Membrane.Format.PlanningRequest{\n    ...>   domain: nil,\n    ...>   state: nil,\n    ...>   goals: [],\n    ...>   options: [],\n    ...>   request_id: \"req_123\",\n    ...>   conversion_metadata: %{}\n    ...> }\n    iex> Membrane.Format.PlanningRequest.valid?(request)\n    true\n"
