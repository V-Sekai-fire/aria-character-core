...
defmodule Membrane.Format.PlanningResult do
  ...
  @doc "Validates a planning result format structure.\n\n## Examples\n\n    iex> result = %Membrane.Format.PlanningResult{\n    ...>   status: :success,\n    ...>   result: %{},\n    ...>   execution_metadata: %{},\n    ...>   request_id: \"req_123\",\n    ...>   performance_metrics: %{}\n    ...> }\n    iex> Membrane.Format.PlanningResult.valid?(result)\n    true\n"
