...
## Context
The temporal planner requires different queuing strategies based on time ordering constraints. Some operations must execute sequentially to maintain temporal correctness, while others can execute in parallel for performance.
