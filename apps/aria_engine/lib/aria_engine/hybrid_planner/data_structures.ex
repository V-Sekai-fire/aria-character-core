...
defmodule AriaEngine.HybridPlanner.DataStructures do
  ...
  defmodule EncapsulatedPlan do
    ...
    @doc """
    Get statistics about the plan without exposing internal structure.
    """
    ...
    @doc """
    Get the cost (number of primitive actions) of the plan.
    """
    ...
    @doc """
    Check if the plan has been temporally validated.
    """
    ...
    @doc """
    Mark plan as temporally validated.
    """
  ...
  defmodule PlanningContext do
    @moduledoc """
    Encapsulated planning context that separates planning state from world state.
    """
    ...
    @doc """
    Blacklist a method in this context.
    """
    ...
    @doc """
    Check if a method is blacklisted.
    """
    ...
    @doc """
    Get the verbose level for logging.
    """
