...
defmodule AriaFlow.Behaviour do
  @moduledoc """
  Behaviour defining the interface for stream processing functionality.
  
  This allows aria_engine and other consumers to work with different flow processing 
  implementations without being tightly coupled to the AriaFlow implementation details. 
  This follows dependency inversion principles and makes testing much easier.
  """
  ...
  @doc """
  Process data through a pipeline with backflow processing.
  """
  @callback process_with_backflow(pipeline :: atom(), data :: list(), opts :: keyword()) :: map()
