...
defmodule AriaFlow.Element do
  ...
  @doc """
  Send buffer to element for asynchronous processing (Membrane-style).
  
  In Membrane, buffers flow asynchronously through elements via message passing.
  This follows that pattern rather than synchronous processing.
  """
