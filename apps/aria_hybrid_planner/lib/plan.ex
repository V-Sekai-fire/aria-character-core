...
defmodule Plan do
  ...
  @spec run_lazy_refineahead(Domain.Core.t(), AriaEngine.State.t(), term(), keyword()) :: {:ok, AriaEngine.State.t()} | {:error, String.t()}
  ...
  @spec replan(Domain.Core.t(), AriaEngine.State.t(), solution_tree(), node_id(), keyword()) :: plan_result()
