...
defmodule AriaBlocksWorldTest do
  @moduledoc """
  AriaBlocksWorldTest provides a blocks world planning domain implementation using AriaEngineCore.
  ...
  ## Usage
      ...
      # Solve the problem
      {:ok, {final_state, solution_tree}} = AriaBlocksWorldTest.solve_problem(state, [goal])
  ...
  ## Examples
      ...
      iex> state = AriaBlocksWorldTest.create_state(%{
      ...>   pos: %{"a" => "table", "b" => "table"},
      ...>   clear: %{"a" => true, "b" => true},
      ...>   holding: %{"hand" => false}
      ...> })
  ...
  ## Examples
      ...
      iex> goal = AriaBlocksWorldTest.create_multigoal(%{
      ...>   pos: %{"a" => "b", "b" => "table"}
      ...> })
  ...
  ## Example
      ...
      {:ok, solution_tree} = AriaBlocksWorldTest.plan_problem(state, [goal])
  """
  ...
  ## Examples
      ...
      iex> {:ok, result} = AriaBlocksWorldTest.run_example(:simple_pickup)
      iex> result.name
      "Simple Pickup"
      ...
      iex> {:error, reason} = AriaBlocksWorldTest.run_example(:unknown_example)
      iex> reason
      :unknown_example
  """
  ...
  ## Examples
      ...
      iex> examples = AriaBlocksWorldTest.list_examples()
  ...
  ## Examples
      ...
      iex> info = AriaBlocksWorldTest.domain_info()
      iex> info.name
      "Blocks World Domain"
