...
defmodule AriaEngine.Scheduler.DomainConverter.KHRPrimitives do
  ...
  @doc "Create KHR primitive sequence for a specific activity.\n"
  ...
  @doc "Create dependency check primitive.\n"
  ...
  def create_dependency_check_primitive(activity_id, dependency_id) do
    %{
      ...
      timing: %{when: "at_start", duration: 0, priority: "high"}
    }
  end

  @doc "Create resource allocation primitive.\n"
  ...
  @doc "Create activity execution primitive.\n"
  ...
  @doc "Create resource deallocation primitive.\n"
  ...
  def create_resource_deallocation_primitive(activity_id, resource_id) do
    %{
      ...
      timing: %{when: "at_end", duration: 0, priority: "high"}
    }
  end

  @doc "Create completion marking primitive.\n"
  ...
  @doc "Parse duration value for KHR timing format.\n"
  ...
  def parse_duration_for_khr(duration_val) do
    cond do
      ...
      is_number(duration_val) ->
        %{when: "over_all", duration: duration_val, priority: "medium"}
  ...
  @doc "Create KHR primitive for temporal constraint solving.\n"
  ...
  def create_temporal_constraint_primitive(activities) do
    %{
      ...
      timing: %{when: "before_execution", duration: "variable", priority: "critical"}
    }
  end

  @doc "Create KHR primitive for resource optimization.\n"
  ...
  def create_resource_optimization_primitive(resources) do
    %{
      ...
      timing: %{when: "during_execution", duration: "continuous", priority: "low"}
    }
  end

  @doc "Convert duration map to seconds for KHR timing.\n"
  ...
  @doc "Validate KHR primitive sequence for consistency.\n"
