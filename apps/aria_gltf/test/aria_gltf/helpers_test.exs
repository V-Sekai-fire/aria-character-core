...
defmodule AriaGltf.HelpersTest do
  ...
  describe "create_minimal_document/1" do
    ...
    test "creates minimal document with custom options" do
      doc =
        Helpers.create_minimal_document(
          generator: "TestApp",
  ...
  describe "create_simple_animation/1" do
    test "creates animation with required properties" do
      animation =
        Helpers.create_simple_animation(
          name: "Rotate",
          target_node: 0,
          path: "rotation",
          input_accessor: 0,
  ...
  describe "create_cube_mesh/1" do
    test "creates complete cube mesh data" do
      ...
      # FLOAT
      assert position_acc.component_type == 5126
      ...
      # FLOAT
      assert normal_acc.component_type == 5126
      ...
      # FLOAT
      assert texcoord_acc.component_type == 5126
      ...
      # UNSIGNED_SHORT
      assert index_acc.component_type == 5123
