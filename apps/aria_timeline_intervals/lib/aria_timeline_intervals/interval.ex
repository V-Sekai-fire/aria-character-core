...
defmodule AriaTimelineIntervals.Interval do
  ...
  ## Examples
      ...
      iex> interval = AriaTimelineIntervals.Interval.new(start_dt, end_dt)
  ...
  ## Examples
      ...
      iex> start_dt = DateTime.from_naive!(~N[2023-01-01 00:00:00], "Etc/UTC")
      iex> end_dt = DateTime.from_naive!(~N[2023-01-01 00:05:30], "Etc/UTC")
      iex> interval = AriaTimelineIntervals.Interval.new(start_dt, end_dt, metadata: %{type: :action})
  ...
  ## Examples
      ...
      iex> end_dt = DateTime.from_naive!(~N[2023-01-01 00:05:30], "Etc/UTC")
      iex> interval = AriaTimelineIntervals.Interval.new(start_dt, end_dt)
      iex> AriaTimelineIntervals.Interval.duration_ms(interval)
      330000
  ...
  ## Examples
      ...
      iex> end_dt = DateTime.from_naive!(~N[2023-01-01 00:05:30], "Etc/UTC")
      iex> interval = AriaTimelineIntervals.Interval.new(start_dt, end_dt)
      iex> AriaTimelineIntervals.Interval.duration_seconds(interval)
      330.0
  ...
  ## Examples
      ...
      iex> AriaTimelineIntervals.Interval.contains?(interval, check_time)
      true
  ...
  ## Examples
      ...
      iex> start_dt = DateTime.from_naive!(~N[2025-01-01 10:00:00], "Etc/UTC")
      iex> end_dt = DateTime.from_naive!(~N[2025-01-01 12:00:00], "Etc/UTC")
      iex> interval = AriaTimelineIntervals.Interval.new(start_dt, end_dt, agent: agent)
      iex> AriaTimelineIntervals.Interval.agent?(interval)
      true
  ...
  ## Examples
      ...
      iex> start_dt = DateTime.from_naive!(~N[2025-01-01 10:00:00], "Etc/UTC")
      iex> end_dt = DateTime.from_naive!(~N[2025-01-01 12:00:00], "Etc/UTC")
      iex> interval = AriaTimelineIntervals.Interval.new(start_dt, end_dt, entity: entity)
      iex> AriaTimelineIntervals.Interval.entity?(interval)
      true
  ...
  @doc """
  Validates an interval for correctness.
  ...
  ## Examples
      ...
      iex> end_dt = DateTime.from_naive!(~N[2023-01-01 00:05:30], "Etc/UTC")
      iex> interval = AriaTimelineIntervals.Interval.new(start_dt, end_dt)
      iex> AriaTimelineIntervals.Interval.validate(interval)
      :ok

  """
  @spec validate(t()) :: :ok | {:error, String.t()}
  def validate(%__MODULE__{start_time: start_time, end_time: end_time}) do
    cond do
      is_nil(start_time) -> {:error, "start_time cannot be nil"}
      is_nil(end_time) -> {:error, "end_time cannot be nil"}
      DateTime.compare(start_time, end_time) == :gt -> {:error, "start_time must be before or equal to end_time"}
      true -> :ok
    end
  end
  ...
  ## Examples
      ...
      iex> interval = AriaTimelineIntervals.Interval.new(start_dt, end_dt)
      iex> AriaTimelineIntervals.Interval.duration_in_unit(interval, :minute)
      60
  ...
  ## Examples
      ...
      iex> start_dt = DateTime.from_naive!(~N[2023-01-01 00:00:00], "Etc/UTC")
      iex> interval = AriaTimelineIntervals.Interval.from_duration(start_dt, 30, :minute)
      iex> AriaTimelineIntervals.Interval.duration_in_unit(interval, :minute)
      30
  ...
  ## Examples
      ...
      iex> interval = AriaTimelineIntervals.Interval.new(start_dt, end_dt)
      iex> {_start_point, _end_point, duration} = AriaTimelineIntervals.Interval.to_stn_points(interval, :second)
      iex> duration
      300
  ...
  ## Examples
      ...
      iex> interval1 = AriaTimelineIntervals.Interval.new(start1, end1)
      iex> start2 = DateTime.from_naive!(~N[2023-01-01 00:30:00], "Etc/UTC")
      iex> end2 = DateTime.from_naive!(~N[2023-01-01 01:30:00], "Etc/UTC")
      iex> interval2 = AriaTimelineIntervals.Interval.new(start2, end2)
      iex> AriaTimelineIntervals.Interval.overlaps?(interval1, interval2)
      true
  ...
  defp unit_to_microseconds(:millisecond), do: 1000
