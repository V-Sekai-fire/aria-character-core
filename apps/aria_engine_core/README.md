...
The foundational game engine providing core planning capabilities for Aria applications.

## Overview

AriaEngineCore is the stable, proven implementation of the AriaEngine planning system. It provides:

- **State Management**: PSO (Predicate-Subject-Object) triple-based world state representation
- **Classical Planning**: HTN (Hierarchical Task Network) style planning algorithms  
- **Action Library**: Comprehensive set of primitive actions and methods
- **Domain Modeling**: Flexible domain definition and goal specification

This is the core implementation that has been battle-tested across multiple Aria applications and serves as the foundation for temporal planning extensions.
