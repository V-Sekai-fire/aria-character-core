...
try do
  ...
  modules = [
    ...
    "apps/aria_engine/lib/aria_engine/blocks_world_actions.ex",
    "apps/aria_engine/lib/aria_engine/blocks_world_methods.ex",
  ...
  domain = AriaEngine.build_blocks_world_domain()
