defmodule TemporalPlanner.STNMethodTest do
  ...
  describe("bridge actions") do
    ...
    test "bridge actions create temporal segments" do
      ...
      bridge = %{action_id: "checkpoint", type: :condition, duration: :instantaneous}
      updated_method = STNMethod.add_bridge_action(method, bridge)
  ...
  describe("method composition") do
    test "chains methods sequentially" do
      method1 =
        STNMethod.new("setup", :sequential, [STNAction.new("prepare", duration: {1000, 2000})])

      method2 =
        STNMethod.new("execute", :parallel, [STNAction.new("perform", duration: {3000, 4000})])
    ...
    test "executes methods in parallel" do
      method1 =
        STNMethod.new("recon", :sequential, [STNAction.new("scout", duration: {2000, 3000})])

      method2 =
        STNMethod.new("comms", :parallel, [STNAction.new("radio_check", duration: {1000, 1500})])
