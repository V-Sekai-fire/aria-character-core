...
defmodule AriaEngine.Scheduler.DomainConverterTest do
  ...
  describe "convert_activities_to_khr_domain/4" do
    test "compiles and runs without StateV2 undefined errors" do
      ...
      result = DomainConverter.convert_activities_to_khr_domain(activities, entities, resources, constraints)
    ...
    test "creates valid domain structure" do
      ...
      assert {:ok, domain} = DomainConverter.convert_activities_to_khr_domain(activities, entities, resources, constraints)
