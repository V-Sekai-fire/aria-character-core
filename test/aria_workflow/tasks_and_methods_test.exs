...
defmodule AriaWorkflow.TasksAndMethodsTest do
  ...
  describe "BasicTiming Tasks" do
    ...
    test "stop_timer calculates duration correctly" do
      ...
      # Stop the timer
      {:ok, final_state} = AriaWorkflow.Tasks.BasicTiming.stop_timer(state_with_timer, %{
        timer_id: "duration_test",
        status: :completed
      })
      ...
      timer_result = Map.get(completed_timers, "duration_test", %{})
  ...
  describe "Edge Cases and Error Handling" do
    test "handles empty state gracefully" do
      ...
      {:ok, _updated_state} = AriaWorkflow.Tasks.BasicTiming.get_current_time(state)
